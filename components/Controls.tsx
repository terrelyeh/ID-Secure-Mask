...
export const Controls: React.FC<ControlsProps> = ({
  ...
  return (
    <div className="flex flex-col gap-0 bg-white rounded-xl shadow-sm border border-slate-200 h-full overflow-y-auto divide-y divide-slate-100">
